...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/06/2025 às 00:03
...
--
-- Estrutura para tabela `si_ordem_servico`
--
...
--
-- Estrutura para tabela `si_pedido_material`
--
...
CREATE TABLE `si_pedido_material` (
  ...
  `pedido_despachado` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Índices de tabela `si_ordem_servico`
--
ALTER TABLE `si_ordem_servico`
  ADD PRIMARY KEY (`os_id`);

--
-- Índices de tabela `si_pedido_material`
--
